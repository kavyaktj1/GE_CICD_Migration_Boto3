...
exec_time_ignore_list = ['arn:aws:states:us-east-1:245792935030:stateMachine:MAPP_CDS_SNAPSHOT_GLPROD_CONTINGENCY','arn:aws:states:us-east-1:245792935030:stateMachine:MAPP_MASTER_CONTINGENCY_SCHEDULE']

flag_Mapp_flat = False
flag_Mapp_glprod = False
last_run_flag = False

df = pandas.read_csv('Scripts/SFN_Details_MAPP_Contingency.csv')
...
df.to_csv('Scripts/SFN_Status_Archive/ODP_MAPP_Contingency_Load_Status '+dt_string+'.csv', index=False, encoding='utf-8')
