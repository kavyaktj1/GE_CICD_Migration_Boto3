...
if len(path_list)>=0:        
    ...
    with open('manifest_ddl_git_info.json', 'rb') as data:
        s3.upload_fileobj(data, 'odp-us-nprod-servicesuite', 'common/502818085/ODP/manifest/manifest_ddl_git_info.json')

response = s3.get_object(
    Bucket='odp-us-nprod-servicesuite',
    Key='common/502818085/ODP/manifest/manifest_ddl_order.json'
)
