...
for index in range(size):
    job = df['SFN'][index]
    if 'daasbatchextract' in job:
        config['RoleArn'] = 'arn:aws:iam::245792935030:role/odp-us-prod-daasbatchextract-service-role'
    else:
        config['RoleArn'] = 'arn:aws:iam::245792935030:role/ODP-US-Prod-AWSServiceRole'
