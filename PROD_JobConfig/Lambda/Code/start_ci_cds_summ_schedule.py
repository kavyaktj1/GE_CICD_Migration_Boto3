...
def ddb_update_records(**kwargs):
    try:
        ...
        if kwargs['partKey'] == "CI-Summary" or kwargs['partKey'] == "DQ-Framework":
    ...
    try:
        ...
        if validate_date_repsonse:
            try:
                ...
                ci_partKey, ci_sortKey = 'CI-Summary', validate_date_repsonse
                dqf_partKey, dqf_sortKey = 'DQ-Framework', validate_date_repsonse

                print("sp {}, sk {}".format(ci_partKey, ci_sortKey))

                ddb_second_response = ddb_get_unique_record(ci_partKey, ci_sortKey)
                ...
                if ddb_second_response:
                    ...
                    ddb_default_data = {
                        ...
                        "CI_CDS": ddb_second_response['CI_CDS']
                    }
                    ...
                    if len(check_n_count) == 1:
                        ...
                        msg = "CI_CDS & SR_CDS loads are completed and starting CI CDS Summary"
                        print(msg)
                        ...
                        msg = "{} only completed yet to start CI CDS Summary".format(TRACK_NAME)
                        print(msg)
