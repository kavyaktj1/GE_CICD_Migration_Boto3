# This script will take the SFN names as input and will delete those SFN's in QA Environment.
...
def delete_job(var): # This function will take the job name as argument and will delete that job from QA Environment.
