    ...
    try:
        ...
        if validate_date_repsonse:
            try:
                ...
                print("sp {}, sk {}".format(ecom_partKey, ecom_sortKey))

                ddb_second_response = ddb_get_unique_record(ecom_partKey, ecom_sortKey)
                ...
                if ddb_second_response:
                    ...
                    ddb_default_data = {
                        ...
                        "IBMF_ENTITY": ddb_second_response['IBMF_ENTITY']
                    }
                    ...
                    if len(check_n_count) == 1:
                        ...
                        msg = "SR CDS & IBMF loads are completed and starting NONSS E-COMMERCE Entity / CDS"
                        print(msg)
                        ...
                        msg = "{} only completed yet to start NONSS E-COMMERCE Entity / CDS".format(TRACK_NAME)
                        print(msg)
